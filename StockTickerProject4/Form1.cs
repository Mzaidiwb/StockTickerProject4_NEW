...
namespace StockTickerProject4
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //Keeps the Y axis looking much cleaner
        ...
        {
            //Continually adjusts the graph axis for better viewing
        ...
        public void Graph_MSFT()
        {
            ...
            List<string> Stock_Dates = Program.CSV.Stock_Dates(); //dates for all stocks (5 years from april 5 2021)
            List<string> MSFT1 = Program.CSV.MSFT_Price();
            List<double> MS_PRICE = MSFT1.Select(double.Parse).ToList();
            Task.Run(() => chart1.Invoke((MethodInvoker)(async () => //method invoke is need because we cannot work on the UI
                                                                     //thread without causing an exception, this allows us to 
                                                                     //work on the thread we need and go back
            {
                for (int i = 0; i < MS_PRICE.Count; i++) //iterate through the list until done
                {
                    chart1.Series[0].Points.AddXY(Stock_Dates[i], MS_PRICE[i]); //add points to chart from list
                    await Task.Delay(1000); //Graph updates every 1 second
                } 
            })));
        }
        ...
        public void Graph_FB()
        {
            ...
            Task.Run(() => chart2.Invoke((MethodInvoker)(async () =>
            {
                ...
                {
                    chart2.Series[0].Points.AddXY(Stock_Dates[i], FB_Price[i]);
        ...
        public void Graph_VOO()
        {
            ...
            Task.Run(() => chart3.Invoke((MethodInvoker)(async () =>
            {
                ...
                {
                    chart3.Series[0].Points.AddXY(Stock_Dates[i], VOO_Price[i]);
                    await Task.Delay(1000);
                }
            })));
        }
        ...
        public void Graph_F()
        {
            ...
            Task.Run(() => chart4.Invoke((MethodInvoker)(async () =>
            {
                ...
                {
                    chart4.Series[0].Points.AddXY(Stock_Dates[i], F_Price[i]);
                    await Task.Delay(1000);
                }
            })));
        }
        ...
        public void Graph_DIS()
        {
            ...
            Task.Run(() => chart5.Invoke((MethodInvoker)(async () =>
            {
                ...
                {
                    chart5.Series[0].Points.AddXY(Stock_Dates[i], DIS_Price[i]);
                    await Task.Delay(1000);
                }
            })));
        }
        public void Graph_KO()
        {
            ...
            Task.Run(() => chart6.Invoke((MethodInvoker)(async () =>
            {
                ...
                {
                    chart6.Series[0].Points.AddXY(Stock_Dates[i], KO_Price[i]);
                    await Task.Delay(1000);
                }
            })));
        }
